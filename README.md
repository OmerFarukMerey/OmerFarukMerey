...
Part-time Software Engineer at Turkish Aerospace Industries Inc. (TAI) at Project TF-X (MMU) Flight Control System Software team.<br>
I am very interested in the field of Data Science and Artificial Intelligence <br> <br>
*(Job Update!)I will be joining to Data Science and Modelling Team at Turkish Aerospace Industries Inc. (TAI) by the end of January. Where we will develop an artificial intelligence agent that learns to fly the aircraft through pilot interfaces by using reinforcement learning techniques.*
## 🌐 Socials:
